	...
	settings: {
		...
		fileExplorer: {
			...
			extensions: {
				...
				candidatesCompound: "复合后缀",
				compoundBadge: "复合",
				addDialog: {
					title: "添加扩展名规则",
					hint: "输入或粘贴扩展名，空格或逗号分隔，可一次添加多个；支持复合后缀（如 excalidraw.md，优先于 md）。",
					placeholder: "如 png jpg excalidraw.md",
					chipExists: "已配置，提交时将更新",
					chipInvalid: "无法识别为扩展名",
					errorEmpty: "请先输入或选择至少一个扩展名",
					errorInvalid: "请先移除无法识别的项：{tokens:string}",
					groupHint: "留空则不分组；填已有分组名则并入该组。",
					iconLabel: "图标",
					colorLabel: "颜色",
					colorReset: "清除颜色",
					resultUpdated: "已更新 {count:number} 个扩展名",
					resultMixed:
						"已添加 {added:number} 个，更新 {updated:number} 个扩展名",
				},
				select: {
					toggleTooltip: "选择扩展名（批量操作）",
					exitTooltip: "退出选择",
					selectedCount: "已选 {count:number} 个",
					emptyHint: "勾选要批量操作的扩展名",
					assignTooltip: "给选中的扩展名统一设置图标",
					diceTooltip: "给选中的每个扩展名随机掷一个图标",
					clearTooltip: "清空选中项的图标",
					deleteTooltip: "删除选中的规则",
					deleteTitle: "删除 {count:number} 条规则？",
					deleteBody: "这些扩展名将回落到「文件默认图标」。",
					deleteConfirm: "删除",
					deleted: "已删除 {count:number} 条规则",
					groupCheckLabel: "选择本组全部扩展名",
					rowCheckLabel: "选择 .{ext:string}",
				},
			},
			extGroup: {
				groupTooltip: "移到分组…",
